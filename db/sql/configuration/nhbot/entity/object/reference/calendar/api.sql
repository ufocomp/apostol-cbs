...
BEGIN
  ...
  RETURN CreateCalendar(pParent, coalesce(pType, GetType('workday.calendar')), pCode, pName, pWeek, JsonbToIntArray(pDayOff), aHoliday[2:], pWorkStart, pWorkCount, pRestStart, pRestCount, pDescription);
END;
$$ LANGUAGE plpgsql
   SECURITY DEFINER
