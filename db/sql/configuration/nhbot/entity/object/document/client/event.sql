...
BEGIN
  ...
  IF uUserId IS NOT NULL THEN
    ...
    IF uAreaType = GetAreaType('guest') THEN
      PERFORM DeleteMemberFromArea(uArea, uUserId);
      uArea := GetAreaDefault();
	  PERFORM ChangeDocumentArea(pObject, uArea);
	END IF;
...
BEGIN
  ...
  IF uUserId IS NOT NULL THEN
    ...
    PERFORM AddMemberToArea(uUserId, '00000000-0000-4003-a000-000000000002'); -- guest

    PERFORM SetDefaultArea('00000000-0000-4003-a000-000000000002', uUserId); -- guest
